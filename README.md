...
* Authoring tool in the form of a Blender add-on, see the instructions in the local [authoring](authoring/) directory.
* Bare-hand interaction with LightBenders, see the instructions in the local [Interaction](Interaction/) directory.
* Upload the video recording and log files generated by an illumination to a Google drive for further analysis.
